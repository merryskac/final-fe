...
const CommentSection = () => {
  ...
  const {response: comment, pending, error} = useFetch('https://final-term-git-main-wheytosharepalu-gmailcom.vercel.app/play/comments/'+id)

  const [user, setUser] = useContext(UserContext)
  const url = 'https://final-term-git-main-wheytosharepalu-gmailcom.vercel.app/play/comments/'+id
