...
const CommentSection = () => {
  ...
  const {response: comment, pending, error} = useFetch('https://final-term-ashen.vercel.app/play/comments/'+id)

  const [user, setUser] = useContext(UserContext)
  const url = 'https://final-term-ashen.vercel.app/play/comments/'+id
